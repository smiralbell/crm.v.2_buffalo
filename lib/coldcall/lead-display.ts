...
const DB_FIELD_GETTERS: Partial<Record<InternalFieldKey, (lead: LeadDisplayInput) => string | null>> = {
  ...
  correo: (l) => l.email,
  denominacion_social: (l) => l.empresa,
  posicion: (l) => l.cargo,
  sector: (l) => l.sector,
  ciudad: (l) => l.zona,
  ...
  web: (l) => l.web,
  cif: (l) => l.cif,
  direccion: (l) => l.direccion,
}

const FALLBACK_PRIMARY: { label: string; get: (l: LeadDisplayInput) => string | null }[] = [
  { label: 'Nombre', get: (l) => l.nombre },
  { label: 'Teléfono', get: (l) => l.telefono },
  { label: 'Correo', get: (l) => l.email },
  { label: 'Empresa', get: (l) => l.empresa },
  { label: 'Cargo', get: (l) => l.cargo },
  { label: 'Sector', get: (l) => l.sector },
  { label: 'Ciudad', get: (l) => l.zona },
  { label: 'CIF', get: (l) => l.cif },
  { label: 'Dirección', get: (l) => l.direccion },
  { label: 'LinkedIn', get: (l) => l.linkedin },
  { label: 'Web', get: (l) => l.web },
]
